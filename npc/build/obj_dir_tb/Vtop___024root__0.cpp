...
void Vtop___024root___ico_sequent__TOP__0(Vtop___024root* vlSelf) {
        ...
        = (((- (IData)((vlSelfRef.instruct_i >> 0x0000001fU))) 
            << 0x0000000cU) | ((0x00000fe0U & (vlSelfRef.instruct_i 
                               ...
                               | (0x0000001fU & ((IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_5)
                                                 ...
                                                 (vlSelfRef.instruct_i 
                                                  >> 0x00000014U)))));
    vlSelfRef.top__DOT__i_L3_XU__DOT__mem_addr = (vlSelfRef.top__DOT__i_L2_DU__DOT__i_GPR__DOT__GPR
                                                  [
                                                  (0x0000001fU 
                                                   & (vlSelfRef.instruct_i 
                                                      >> 0x0000000fU))] 
    ...
    vlSelfRef.top__DOT__i_L3_XU__DOT__mem_wen = ((~ 
                                                  (0U 
                                                   != 
                                                   (vlSelfRef.top__DOT__i_L3_XU__DOT__mem_addr 
                                                    >> 0x0000001dU))) 
                                                 & (IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_5));
    vlSelfRef.top__DOT__i_L3_XU__DOT__mem_din = ((IData)(vlSelfRef.top__DOT__i_L2_DU__DOT__op_sb)
                                                  ? 
                                                 ((3U 
                                                   == 
                                                   (3U 
                                                 ...
                                                 [(0x0000001fU 
                                                   & (vlSelfRef.instruct_i 
                                                      >> 0x00000014U))]);
    if ((((~ (0U != (vlSelfRef.top__DOT__i_L3_XU__DOT__mem_addr 
                     >> 0x0000001dU))) & (IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_3)) 
         | (IData)(vlSelfRef.top__DOT__i_L3_XU__DOT__mem_wen))) {
        Vtop___024root____Vdpiimwrap_top__DOT__i_L4_SU__DOT__pmem_read_TOP(vlSelfRef.top__DOT__i_L3_XU__DOT__mem_addr, vlSelfRef.__Vfunc_top__DOT__i_L4_SU__DOT__pmem_read__0__Vfuncout);
        vlSelfRef.top__DOT__i_L4_SU__DOT__mem_dout 
            = vlSelfRef.__Vfunc_top__DOT__i_L4_SU__DOT__pmem_read__0__Vfuncout;
        if (vlSelfRef.top__DOT__i_L3_XU__DOT__mem_wen) {
            Vtop___024root____Vdpiimwrap_top__DOT__i_L4_SU__DOT__pmem_write_TOP(vlSelfRef.top__DOT__i_L3_XU__DOT__mem_addr, vlSelfRef.top__DOT__i_L3_XU__DOT__mem_din, 
                                                                                ((((((3U 
                                                                                == 
                                                                                (3U 
                                                                                & vlSelfRef.top__DOT__i_L3_XU__DOT__mem_addr)) 
    ...
    vlSelfRef.top__DOT__i_L4_SU__DOT__mem_dout_byte8 
        = (0x000000ffU & ((3U == (3U & vlSelfRef.top__DOT__i_L3_XU__DOT__mem_addr))
                           ? (vlSelfRef.top__DOT__i_L4_SU__DOT__mem_dout 
                              >> 0x00000018U) : ((2U 
                                                  == 
                                                  (3U 
    ...
    vlSelfRef.top__DOT__i_L4_SU__DOT__mem_out_val = 
        ((IData)(vlSelfRef.top__DOT__i_L2_DU__DOT__op_lbu)
          ...
          : vlSelfRef.top__DOT__i_L4_SU__DOT__mem_dout);
    vlSelfRef.top__DOT__i_L2_DU__DOT__i_GPR__DOT__foor_loop_i__BRA__0__KET____DOT__R__DOT__din 
        = ((IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_3)
            ? vlSelfRef.top__DOT__i_L4_SU__DOT__mem_out_val
            : ((0x37U == (0x0000007fU & vlSelfRef.instruct_i))
            ...
            if ((0x000000000000000aULL & vlSelfRef.__VicoTriggered[0U])) {
                {
                    ...
                    vlSelfRef.top__DOT__i_L2_DU__DOT__i_GPR__DOT__foor_loop_i__BRA__0__KET____DOT__R__DOT__rst 
                        = ((IData)(vlSelfRef.rst) | 
...
void Vtop___024root___nba_sequent__TOP__1(Vtop___024root* vlSelf) {
    ...
    if (VL_UNLIKELY(((1U & ((~ (IData)(vlSelfRef.btn)) 
        ...
        VL_WRITEF_NX("Cur PC:%03h PC_N:0x%h Ins:0x%h%d\n",4
                     ...
                     , '#',30,(0x03ffffffU & (vlSelfRef.top__DOT__PC 
                                              >> 2U))
                     , '#',32,vlSelfRef.top__DOT__PC
                     , '#',32,vlSelfRef.instruct_i);
    }
    if ((1U & ((~ (IData)(vlSelfRef.uart_tx)) & (~ (IData)(vlSelfRef.top__DOT__i_L2_DU__DOT__i_GPR__DOT__foor_loop_i__BRA__0__KET____DOT__R__DOT__rst))))) {
        if (VL_UNLIKELY((vlSelfRef.top__DOT__i_L2_DU__DOT__op_add))) {
            VL_WRITEF_NX("%03d-%8x %08h  | add  rd  ,rs1,rs2\n                       - add  r%-2d ,r%-2d,r%-2d     {r%-2d -> 0x%h = r%-2d[0x%h] + r%-2d[0x%h]}\n",12
                         , '#',30,(0x03ffffffU & (vlSelfRef.top__DOT__PC 
                                                  >> 2U))
                         , '#',32,vlSelfRef.top__DOT__PC
                         , '#',32,vlSelfRef.instruct_i
                         ...
                         , '#',5,(0x0000001fU & (vlSelfRef.instruct_i 
                                                 >> 7U))
                         , '#',32,vlSelfRef.top__DOT__i_L2_DU__DOT__i_GPR__DOT__foor_loop_i__BRA__0__KET____DOT__R__DOT__din
                         , '#',5,(0x0000001fU & (vlSelfRef.instruct_i 
                                                 >> 0x0000000fU))
                         ...
                         [(0x0000001fU & (vlSelfRef.instruct_i 
                                          >> 0x00000014U))]);
        } else if (VL_UNLIKELY((vlSelfRef.top__DOT__i_L2_DU__DOT__op_addi))) {
            VL_WRITEF_NX("%03d-%8x %08h  | addi rd , rs1,imm\n                       - addi r%-2d, r%-2d,0x%3h   {r%-2d -> 0x%h or %d}\n",9
                         , '#',30,(0x03ffffffU & (vlSelfRef.top__DOT__PC 
                                                  >> 2U))
                         , '#',32,vlSelfRef.top__DOT__PC
                         , '#',32,vlSelfRef.instruct_i
                         ...
                         , '#',12,(vlSelfRef.instruct_i 
                                   >> 0x00000014U), '#',5,
                         (0x0000001fU & (vlSelfRef.instruct_i 
                                         >> 7U)), '#',32,vlSelfRef.top__DOT__i_L2_DU__DOT__i_GPR__DOT__foor_loop_i__BRA__0__KET____DOT__R__DOT__din
                         , '~',32,vlSelfRef.top__DOT__i_L2_DU__DOT__i_GPR__DOT__foor_loop_i__BRA__0__KET____DOT__R__DOT__din);
        } else if (VL_UNLIKELY(((0x37U == (0x0000007fU 
                                           & vlSelfRef.instruct_i))))) {
            VL_WRITEF_NX("%03d-%8x %08h  | lui  rd , imm\n                       - lui  r%-2d, %5h       {r%-2d -> 0x%h}\n",7
                         , '#',30,(0x03ffffffU & (vlSelfRef.top__DOT__PC 
                                                  >> 2U))
                         , '#',32,vlSelfRef.top__DOT__PC
                         , '#',32,vlSelfRef.instruct_i
            ...
            VL_WRITEF_NX("%03d-%8x %08h  | lw   rd , offset(rs1)\n                       - lw   r%-2d, %6d(r%-2d) {r%-2d -> 0x%h}\n",8
                         , '#',30,(0x03ffffffU & (vlSelfRef.top__DOT__PC 
                                                  >> 2U))
                         , '#',32,vlSelfRef.top__DOT__PC
                         , '#',32,vlSelfRef.instruct_i
            ...
            VL_WRITEF_NX("%03d-%8x %08h  | lbu  rd , offset(rs1)\n                       - lbu  r%-2d, %6d(r%-2d) {r%-2d -> 0x%h}\n",8
                         , '#',30,(0x03ffffffU & (vlSelfRef.top__DOT__PC 
                                                  >> 2U))
                         , '#',32,vlSelfRef.top__DOT__PC
                         , '#',32,vlSelfRef.instruct_i
            ...
            VL_WRITEF_NX("%03d-%8x %08h  | sw   rs2, offset(rs1)\n                       - sw   r%-2d, %6d(r%-2d) {M[0x%4h] -> 0x%h}\n",8
                         , '#',30,(0x03ffffffU & (vlSelfRef.top__DOT__PC 
                                                  >> 2U))
                         , '#',32,vlSelfRef.top__DOT__PC
                         , '#',32,vlSelfRef.instruct_i
                         ...
                         , '#',5,(0x0000001fU & (vlSelfRef.instruct_i 
                                                 >> 0x0000000fU))
                         , '#',32,vlSelfRef.top__DOT__i_L3_XU__DOT__mem_addr
                         , '#',32,vlSelfRef.top__DOT__i_L3_XU__DOT__mem_din);
        } else if (VL_UNLIKELY((vlSelfRef.top__DOT__i_L2_DU__DOT__op_sb))) {
            VL_WRITEF_NX("%03d-%8x %08h  | sb   rs2, offset(rs1)\n                       - sb   r%-2d, %6d(r%-2d) {M[0x%4h] -> 0x%h}\n",8
                         , '#',30,(0x03ffffffU & (vlSelfRef.top__DOT__PC 
                                                  >> 2U))
                         , '#',32,vlSelfRef.top__DOT__PC
                         , '#',32,vlSelfRef.instruct_i
        ...
        } else if (vlSelfRef.top__DOT__i_L2_DU__DOT__op_jalr) {
            VL_WRITEF_NX("%03d-%8x %08h  | jalr rd , offset(rs1)\n                       - jalr r%-2d, %6d(r%2d) {PC -> %3h | r%1d -> 0x%h}\n",9
                         , '#',30,(0x03ffffffU & (vlSelfRef.top__DOT__PC 
                                                  >> 2U))
                         , '#',32,vlSelfRef.top__DOT__PC
                         , '#',32,vlSelfRef.instruct_i
                         ...
                         (0x0000001fU & (vlSelfRef.instruct_i 
                                         >> 0x0000000fU))
                         , '#',32,vlSelfRef.top__DOT__i_L5_BU__DOT__R_PC__DOT__din
                         , '#',5,(0x0000001fU & (vlSelfRef.instruct_i 
                                                 >> 7U))
                         , '#',32,vlSelfRef.top__DOT__i_L2_DU__DOT__i_GPR__DOT__foor_loop_i__BRA__0__KET____DOT__R__DOT__din);
        } else {
            VL_WRITEF_NX("%03d-%8x %08h  | * Instruction Not Found *\n                       - opcode = 0x%2h funct3 = 0b%03b\n",5
                         , '#',30,(0x03ffffffU & (vlSelfRef.top__DOT__PC 
                                                  >> 2U))
                         , '#',32,vlSelfRef.top__DOT__PC
                         , '#',32,vlSelfRef.instruct_i
    ...
    } else if (VL_UNLIKELY(((0x00100073U == vlSelfRef.instruct_i)))) {
        VL_WRITEF_NX("%03d-%8x %08h  | e-break\n",3
                     , '#',30,(0x03ffffffU & (vlSelfRef.top__DOT__PC 
                                              >> 2U))
                     , '#',32,vlSelfRef.top__DOT__PC
                     , '#',32,vlSelfRef.instruct_i);
    ...
    vlSelfRef.top__DOT__PC = ((IData)(vlSelfRef.rst)
                               ? 0x80000000U : vlSelfRef.top__DOT__i_L5_BU__DOT__R_PC__DOT__din);
    if (vlSelfRef.top__DOT__i_L2_DU__DOT__i_GPR__DOT__foor_loop_i__BRA__0__KET____DOT__R__DOT__rst) {
    ...
    vlSelfRef.top__DOT__i_L3_XU__DOT__mem_addr = (vlSelfRef.top__DOT__i_L2_DU__DOT__i_GPR__DOT__GPR
                                                  ...
                                                  + vlSelfRef.top__DOT__i_L3_XU__DOT__imm_ext_32b_s);
    vlSelfRef.top__DOT____Vcellout__r_btn3____pinNumber4 
        = ((IData)(vlSelfRef.top__DOT__i_L2_DU__DOT__i_GPR__DOT__foor_loop_i__BRA__0__KET____DOT__R__DOT__rst)
...
bool Vtop___024root___eval_phase__act(Vtop___024root* vlSelf) {
    ...
    // Body
    {
        ...
        vlSelfRef.__VactTriggered[0U] = (QData)((IData)(
                                                        ((((IData)(vlSelfRef.top__DOT__i_L2_DU__DOT__i_GPR__DOT__foor_loop_i__BRA__0__KET____DOT__R__DOT__rst) 
                                                           & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__DOT__i_L2_DU__DOT__i_GPR__DOT__foor_loop_i__BRA__0__KET____DOT__R__DOT__rst__0))) 
                                                          << 1U) 
                                                         | ((IData)(vlSelfRef.clk) 
                                                            & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__clk__1))))));
        vlSelfRef.__Vtrigprevexpr___TOP__clk__1 = vlSelfRef.clk;
        vlSelfRef.__Vtrigprevexpr___TOP__top__DOT__i_L2_DU__DOT__i_GPR__DOT__foor_loop_i__BRA__0__KET____DOT__R__DOT__rst__0 
            = vlSelfRef.top__DOT__i_L2_DU__DOT__i_GPR__DOT__foor_loop_i__BRA__0__KET____DOT__R__DOT__rst;
    }
#ifdef VL_DEBUG
    if (VL_UNLIKELY(vlSymsp->_vm_contextp__->debug())) {
            ...
            if ((3ULL & vlSelfRef.__VnbaTriggered[0U])) {
                {
                    ...
                    vlSelfRef.top__DOT__cnt_clk = ((IData)(vlSelfRef.top__DOT__i_L2_DU__DOT__i_GPR__DOT__foor_loop_i__BRA__0__KET____DOT__R__DOT__rst)
                                                    ? 0U
                                                    : 
                                                   (0x00ffffffU 
                                                    & ((IData)(1U) 
...
void Vtop___024root___eval(Vtop___024root* vlSelf) {
    ...
    do {
        if (VL_UNLIKELY(((0x00002710U < __VicoIterCount)))) {
            ...
            Vtop___024root___dump_triggers__ico(vlSelfRef.__VicoTriggered, "ico"s);
#endif
            VL_FATAL_MT("/home/devi/Desktop/ysyx_testbench/npc/vsrc/top.v", 1, "", "DIDNOTCONVERGE: Input combinational region did not converge after '--converge-limit' of 10000 tries");
        }
    ...
    do {
...
#endif
            VL_FATAL_MT("/home/devi/Desktop/ysyx_testbench/npc/vsrc/top.v", 1, "", "DIDNOTCONVERGE: NBA region did not converge after '--converge-limit' of 10000 tries");
        }
        ...
        do {
            if (VL_UNLIKELY(((0x00002710U < vlSelfRef.__VactIterCount)))) {
                ...
                Vtop___024root___dump_triggers__act(vlSelfRef.__VactTriggered, "act"s);
#endif
                VL_FATAL_MT("/home/devi/Desktop/ysyx_testbench/npc/vsrc/top.v", 1, "", "DIDNOTCONVERGE: Active region did not converge after '--converge-limit' of 10000 tries");
            }
