...
#endif
            VL_FATAL_MT("/home/devi/Desktop/ysyx_testbench/npc/vsrc/top.v", 1, "", "DIDNOTCONVERGE: Settle region did not converge after '--converge-limit' of 10000 tries");
        }
...
VL_ATTR_COLD void Vtop___024root___stl_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    vlSelfRef.top__DOT__i_L2_DU__DOT__i_GPR__DOT__foor_loop_i__BRA__0__KET____DOT__R__DOT__rst 
        = ((IData)(vlSelfRef.rst) | ((IData)(vlSelfRef.sw) 
                                     >> 0x0000000fU));
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__act(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag) {
    ...
    if ((1U & (IData)((triggers[0U] >> 1U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 1 is active: @(posedge top.i_L2_DU.i_GPR.foor_loop_i[0].R.rst)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__i_L2_DU__DOT__i_GPR__DOT__foor_loop_i__BRA__0__KET____DOT__R__DOT__rst = 0;
    vlSelf->top__DOT__i_L2_DU__DOT__i_GPR__DOT__foor_loop_i__BRA__0__KET____DOT__R__DOT__din = 0;
    vlSelf->top__DOT__i_L5_BU__DOT__R_PC__DOT__din = 0;
    vlSelf->top__DOT__i_L4_SU__DOT__mem_out_val = 0;
    vlSelf->top__DOT__i_L4_SU__DOT__mem_dout_byte8 = 0;
    vlSelf->top__DOT__i_L4_SU__DOT__mem_dout = 0;
    vlSelf->top__DOT__i_L3_XU__DOT__mem_addr = 0;
    vlSelf->top__DOT__i_L3_XU__DOT__mem_din = 0;
    vlSelf->top__DOT__i_L3_XU__DOT__mem_wen = 0;
    vlSelf->top__DOT__i_L3_XU__DOT__imm_ext_32b_s = 0;
    ...
    vlSelf->__Vtrigprevexpr___TOP__top__DOT__i_L2_DU__DOT__i_GPR__DOT__foor_loop_i__BRA__0__KET____DOT__R__DOT__rst__0 = 0;
    for (int __Vi0 = 0; __Vi0 < 1; ++__Vi0) {
