...
void Vtop___024root__trace_chg_0_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(((vlSelfRef.__Vm_traceActivity[1U] 
        ...
        bufp->chgIData(oldp+10,(vlSelfRef.top__DOT__i_L2_DU__DOT__wdata),32);
        bufp->chgIData(oldp+11,(vlSelfRef.top__DOT__i_L4_SU__DOT__mem_addr),32);
        bufp->chgIData(oldp+12,(vlSelfRef.top__DOT__i_L4_SU__DOT__mem_din),32);
        bufp->chgBit(oldp+13,(vlSelfRef.top__DOT__i_L4_SU__DOT__mem_wen));
        bufp->chgBit(oldp+14,(((~ (0U != (vlSelfRef.top__DOT__i_L4_SU__DOT__mem_addr 
                                          >> 0x0000001dU))) 
                               & (IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_3))));
        bufp->chgCData(oldp+15,(((((((3U == (3U & vlSelfRef.top__DOT__i_L4_SU__DOT__mem_addr)) 
        ...
        bufp->chgIData(oldp+16,(vlSelfRef.top__DOT__i_L3_XU__DOT__next_PC),32);
        ...
        bufp->chgIData(oldp+20,(vlSelfRef.top__DOT__i_L2_DU__DOT__wdata),32);
        bufp->chgIData(oldp+21,((0x03ffffffU & vlSelfRef.top__DOT__i_L4_SU__DOT__mem_addr)),26);
        bufp->chgBit(oldp+22,((0U != (vlSelfRef.top__DOT__i_L4_SU__DOT__mem_addr 
                                      >> 0x0000001dU))));
        bufp->chgBit(oldp+23,((1U & (~ (0U != (vlSelfRef.top__DOT__i_L4_SU__DOT__mem_addr 
                                               >> 0x0000001dU))))));
        bufp->chgBit(oldp+24,((((3U == (3U & vlSelfRef.top__DOT__i_L4_SU__DOT__mem_addr)) 
                                & (IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_1)) 
                               | (IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_2))));
        bufp->chgBit(oldp+25,((((2U == (3U & vlSelfRef.top__DOT__i_L4_SU__DOT__mem_addr)) 
                                & (IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_1)) 
                               | (IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_2))));
        bufp->chgBit(oldp+26,((((1U == (3U & vlSelfRef.top__DOT__i_L4_SU__DOT__mem_addr)) 
                                & (IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_1)) 
                               | (IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_2))));
        bufp->chgBit(oldp+27,((((IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_1) 
                                & (0U == (3U & vlSelfRef.top__DOT__i_L4_SU__DOT__mem_addr))) 
                               | (IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_2))));
        bufp->chgIData(oldp+28,((0xfffffffeU & vlSelfRef.top__DOT__i_L4_SU__DOT__mem_addr)),32);
        bufp->chgCData(oldp+29,(((((((3U == (3U & vlSelfRef.top__DOT__i_L4_SU__DOT__mem_addr)) 
                                     & (IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_1)) 
                                    | (IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_2)) 
                                   << 3U) | ((((2U 
                                                == 
    ...
    bufp->chgBit(oldp+135,(vlSelfRef.top__DOT__i_L2_DU__DOT__rst));
    ...
    bufp->chgIData(oldp+145,(((0x37U == (0x0000007fU 
                               ...
                               : ((IData)(vlSelfRef.top__DOT__i_L2_DU__DOT__op_jalr)
                                   ? (0xfffffffeU & vlSelfRef.top__DOT__i_L4_SU__DOT__mem_addr)
    ...
    bufp->chgIData(oldp+187,(((3U == (3U & vlSelfRef.top__DOT__i_L4_SU__DOT__mem_addr))
                               ? (vlSelfRef.top__DOT__i_L2_DU__DOT__i_GPR__DOT__GPR
                                  [(0x0000001fU & (vlSelfRef.instruct_i 
                                                   >> 0x00000014U))] 
                                  << 0x00000018U) : 
