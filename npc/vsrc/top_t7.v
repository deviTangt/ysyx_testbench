...
wire ps2_tick_off;
wire ps2_diff = (ps2_code_pre != 8'hf0) && (ps2_code != ps2_code_pre);
...
bcd7seg_AF ins_seg7(.b(ps2_cpde_pre_valid[7:4]), .h(seg7));
bcd7seg_AF ins_seg6(.b(ps2_cpde_pre_valid[3:0]), .h(seg6));
bcd7seg_AF ins_seg5(.b(ps2_code_pre[7:4]), .h(seg5));
bcd7seg_AF ins_seg4(.b(ps2_code_pre[3:0]), .h(seg4));
